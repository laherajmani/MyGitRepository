<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AboutUs.aspx.cs" Inherits="GroceryStore.AboutUs" %>
    ...
    <div id="About-wrapper">
        <div id="container">
            <div class="row">
               ...
               <%-- <li role="presentation"><a class="fa fa-history" href="About-Us">About Us</a></li>--%>
                    ...
                    <li role="presentation"><a class="fa fa-link" href="Vendor/VendorLogin.aspx">Sell With
                        Us</a></li>
                    <li role="presentation"><a class="fa fa-sign-in" href="CustomerLogin.aspx">
                        Login</a></li>
                   
                    <li role="presentation" id="lisignup" runat="server"><a class="fa fa-user glyphicon-plus-sign" href="Customer/UserRegister.aspx">
                        SignUp</a></li>
            ...
            <div id="About-Pagewrapper">
                <hr style="width: 100%; color: black; height: 1px; margin-top: 1%; margin-bottom: 2%;" />
                <div class="row">
                    <div class="col-sm-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                What is OrganiKong ?</div>
                            <div class="panel-body">
                                <p style="text-align: justify;">
                                    A lot of people would like to switch to organic food, but it is frustrating not
                                    to find a complete range of products in their neighborhood stores or online and
                                    organic grocery stores may not be present around them. Organikong is our effort
                                    to bring together certified organic stores and consumers on the same platform. Customers
                                    can place orders and they will be fulfilled and delivered by organic stores located
                                    in their vicinity within 24 hours of placing the order. So sit back and relax, and
                                    enjoy the goodness of healthy organic food!
                                </p>
